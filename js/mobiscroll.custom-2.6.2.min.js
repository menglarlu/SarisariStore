...
K();E("onMarkupReady",[v]);"inline"!=p.display?(v.appendTo("body"),T&&!c&&(v.addClass("dw-trans"),setTimeout(function(){v.removeClass("dw-trans").find(".dw").removeClass(k)},350))):G.is("div")?G.html(v):v.insertAfter(G);E("onMarkupInserted",[v]);W=!0;ka.init(v,n);if("inline"!=p.display){n.tap(a(".dwb-s span",v),function(){n.select()});n.tap(a(".dwb-c span",v),function(){n.cancel()});n.tap(a(".dwo",v),function(){n.cancel()});p.button3&&n.tap(a(".dwb-n span",v),p.button3);a(window).on("keydown.dw",function(a){a.keyCode==13?n.select():a.keyCode==
